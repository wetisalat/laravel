    ...
    methods: {
        ...
        formSubmitted() {
            ...
            if (
                ...
                country = this.$refs.country.selected.name;
            }
            axios
                .post("api/client/setting-location/addlocation", {
                    id: id,
                    ...
                    city: this.city,
                    country: country,
                    conventionName: JSON.stringify(this.selectedconvention),
                    ape: JSON.stringify(this.selectedcodeAPE),
                })
                .then((res) => {
                ...
                .then((res) => {
                    ...
                    result.map((value, index) => {
                        convention.push({
                            ...
                            text: value.convention_collective,
                        });
                    });
