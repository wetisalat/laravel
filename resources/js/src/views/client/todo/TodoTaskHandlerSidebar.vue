      ...
      <template #default="{ hide }">
        ...
        <div class="d-flex justify-content-between align-items-center content-sidebar-header px-2 py-1">
          <b-button
            ...
            @click="taskLocal={...taskLocal, isCompleted: !taskLocal.isCompleted}"
          >
          ...
          <div>
            ...
            <feather-icon
              ...
              @click="taskLocal={...taskLocal, isImportant: !taskLocal.isImportant}"
            />
            <feather-icon
              class="ml-1 cursor-pointer"
              icon="XIcon"
          ...
          >
            ...
            >
              ...
              >
                ...
                <template #option="{ id, avatar, name }">
                  <b-avatar
                    size="20"
                    :src="avatar?`../`+avatar:null"
                    :text="(name.split(' ')[0] != undefined && name.split(' ')[0].length>0?name.split(' ')[0].charAt(0):'')+(name.split(' ')[1] != undefined && name.split(' ')[1].length>0?name.split(' ')[1].charAt(0):'')"
                  />
                  <span class="ml-50 d-inline-block align-middle"> {{ name }}</span>
                </template>

                <template #selected-option="{ id, avatar, name }">
                  <b-avatar
                    size="20"
                    :src= "avatar?`../`+avatar:null"
                    :text="(name.split(' ')[0] != undefined && name.split(' ')[0].length>0?name.split(' ')[0].charAt(0):'')+(name.split(' ')[1] != undefined && name.split(' ')[1].length>0?name.split(' ')[1].charAt(0):'')"
