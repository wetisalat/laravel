...
export default {
  ...
  setup() {
    ...
    const taskFilters = [
      { title: 'My Task', icon: 'MailIcon', route: { name: 'staff-todo' } },
      { title: 'Important', icon: 'StarIcon', route: { name: 'staff-todo-filter', params: { filter: 'important' } } },
      { title: 'Completed', icon: 'CheckIcon', route: { name: 'staff-todo-filter', params: { filter: 'completed' } } },
      { title: 'Deleted', icon: 'TrashIcon', route: { name: 'staff-todo-filter', params: { filter: 'deleted' } } },
    ]
